          ...
          <div class="box-body box-search">
            <form class="form-inline" autocomplete="off" spellcheck="false">
              <div class="form-group form-group-sm">
                <label>搜索</label>
                <input type="text" class="form-control" placeholder="国标编码" v-model.trim="q" @keydown.enter.prevent ref="q">
              </div>
              ...
              <div class="form-group form-group-sm date-from-control">
                <label>报警时间</label>
                <el-date-picker class="form-control date-input" v-model.trim="startDate" type="datetime" placeholder="开始时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                <el-date-picker class="form-control date-input" v-model.trim="endDate" type="datetime" placeholder="结束时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
              </div>
